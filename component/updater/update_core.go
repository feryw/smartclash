...
const (
	...
	baseAlphaURL    = "https://github.com/feryw/smartclash/releases/download/Prerelease-Alpha/"
	versionAlphaURL = "https://github.com/feryw/smartclash/releases/download/Prerelease-Alpha/version.txt"
